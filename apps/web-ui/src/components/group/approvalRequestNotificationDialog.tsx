...
export function ApprovalRequestNotificationSettingModal({ group }: { group: Group }) {
  ...
  return (
    <Dialog.Root open={modalOpen} onOpenChange={setModalOpen}>
      <Dialog.Trigger>
        <Button>Approval request notification</Button>
      </Dialog.Trigger>{" "}
      <Dialog.Content style={{ maxWidth: 450 }}>
        <Dialog.Title>Update approval request Notification</Dialog.Title>
...
export function NotificationPropertyForm({
  ...
  const targetNotificationProperty = group.approvalRequestNotifications?.find(
