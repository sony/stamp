...
import { UpdateGroupMemberNotificationInput } from "./input";
import { updateGroupMemberNotification } from "./updateGroupMemberNotification";

describe("updateGroupMemberNotification", () => {
  ...
  const mockUpdateGroupMemberNotificationGroupProvider = vi.fn((value) => {
  ...
  const groupProvider: GroupProvider = {
    ...
    updateGroupMemberNotification: mockUpdateGroupMemberNotificationGroupProvider,
  ...
  it("should return an error if input parsing fails", async () => {
    const invalidInput = {} as UpdateGroupMemberNotificationInput; // Invalid input
    const result = await updateGroupMemberNotification(
      logger,
      userProvier,
      groupProvider,
  ...
  it("should update group member notification", async () => {
    ...
    const result = await updateGroupMemberNotification(logger, userProvier, groupProvider, groupMemberShipProvider, mockGetNotificationPluginConfig)(input);
