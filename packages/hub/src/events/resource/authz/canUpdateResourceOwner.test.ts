...
import { checkCanUpdateResourceOwnerImpl } from "./canUpdateResourceOwner";
...
const ownerGroupId = "c5bf6fb6-fe25-64e2-3995-6e64b9a8ecab"; // uuid is meaningless and was generated for testing.
...
describe("Testing canUpdateResourceOwner", () => {
  describe("checkCanUpdateResourceOwnerImpl", () => {
    ...
    const input: UpdateResourceOwnerInput = {
      catalogId: catalogId,
      resourceTypeId: resourceTypeId,
      resourceId: resourceId,
      requestUserId: requestUserId,
      ownerGroupId: approverGroupId,
    };

    it("should return ok with valid input", async () => {
      const expected = structuredClone(input);

      const result = await checkCanUpdateResourceOwnerImpl(
        input,
    ...
    it.each([
      ...
      const result = await checkCanUpdateResourceOwnerImpl(input, fn1, fn2, fn3, fn4);
